...
describe User do
  ...
  before(:each) do
    @attr = {:name => "User Name", :email => "user@example.com", 
  ...
  describe "password validations" do
    ...
    it "should reject short passwords" do
      short = "a" * 5;
      hash = @attr.merge(:password => short, :password_corfirmation => short)
      User.new(hash).should_not be_valid
    end
    
    it "should reject long passwords" do
      long = "a" * 21
      hash = @attr.merge(:password => long, :password_corfirmation => long) 
      User.new(hash).should_not be_valid
    end
  ...
  describe "password encryption" do
    ...
    it "should have an encrypted password attributed" do
  ...
  describe "micropost associations" do
    ...
    describe "status feed" do
      ...
      it "should not include a different user's microposts" do
        diff_user = Factory(:user, :email => Factory.next(:email))
        mp3 = Factory(:micropost, :user => diff_user)
  ...
  describe "relationships" do
    ...
    it "should included the followed user in the following array" do
      @user.follow!(@followed)
